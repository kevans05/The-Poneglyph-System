...
class LogPosePanel(tk.Frame):
    ...
    def _build_history_tab(self, parent: tk.Frame) -> None:
        ...
        self._hist_tree.column("timestamp",    width=170, minwidth=150)
        self._hist_tree.column("wo_number",    width=120, minwidth=80)
        self._hist_tree.column("technologist", width=160, minwidth=120)
        self._hist_tree.column("device_count", width=70,  minwidth=50)
        self._hist_tree.column("notes",        width=200, minwidth=100)
